...
namespace AbyssLibU
{
    ...
    /// <summary>
    /// TMP_InputFieldの全角文字入力バグ対応
    /// TMP_InputFieldに追加してください。
    /// </summary>
    [RequireComponent(typeof(TMP_InputField))]
    public class AbyssLibU_TMP_InputfieldZenkakuBSFix : MonoBehaviour
    {
        ...
        private void Start()
        {
            T1 = gameObject.GetComponent<TMP_InputField>();
        }
        ...
        private void Update()
        {
            //日本語入力の全角変換中に確定させない状態でTMP_InputFieldから
        ...
        {
            if(T1.GetComponent<TMP_InputField>().isFocused)
            {
                T1.ForceLabelUpdate();
            }
        }
